...
class ADSConv(nn.Module):
    ...
    def __init__(self, c1, c2, kernel_size=3, stride=1, padding=None, activation=True):
        super(ADSConv, self).__init__()
        padding = self.autopad(kernel_size) if padding is None else padding
